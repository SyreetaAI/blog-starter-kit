export function Intro() {
  return (
    <section className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b py-3 mb-8">
      <div className="container mx-auto px-5 flex flex-col md:flex-row items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 rounded-full overflow-hidden shadow-sm">
            <img src="/assets/blog/authors/syreeta.jpg" alt="Syreeta Craig" className="w-full h-full object-cover" />
          </div>
          <div>
