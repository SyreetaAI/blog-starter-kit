...
export function Intro() {
  return (
    <section className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b py-6 mb-12">
      <div className="container mx-auto px-5 flex flex-col md:flex-row items-center justify-between">
        
        {/* Identity Section */}
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-[#F97316] shadow-sm">
            <img 
          ...
          <h1 className="text-3xl md:text-4xl font-bold tracking-tighter" style={{ color: '#0F172A' }}>
        ...
        <div className="flex items-center gap-6 mt-4 md:mt-0">
          <a href="https://linkedin.com/in/syreetacraig" target="_blank" rel="noopener noreferrer">
            <svg className="w-6 h-6 fill-[#0F172A] hover:fill-[#F97316] transition-colors" viewBox="0 0 24 24">
