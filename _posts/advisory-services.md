...
<div style="font-size: 1.3rem; font-weight: 800; margin-top: -10px; margin-bottom: 15px;">
...
* **Fiduciary Integrity:** Monitoring consumption patterns to maintain fiscal discipline.

<div style="margin-top: -20px;">

### Pillar II: Structural Transformation
I design Strategic Procurement Center of Excellence driven systems that automate the routine while keeping Human-in-the-Loop checkpoints for critical decision-making and strategic alignment.
...
<h3 style="text-align: center; margin-top: -10px; text-decoration: none;">
  <span style="color: #0F172A;">Spend Intelligence</span> <span style="color: #F97316;">With Intent</span>
</h3>

<div style="background: #0F172A; padding: 40px; border-radius: 12px; text-align: center; margin-top: 20px; border: 1px solid #F97316;">
  <h3 style="color: white; margin-bottom: 20px; text-decoration: none;">Request a Forensic Capital Integrity Audit</h3>
